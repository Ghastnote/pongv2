...
export var wallSound = new soundFile("scarysound.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("scarypaddle.mp3");
...
export var ambientSound = new soundFile("other.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -5; //turn down volume
ambientSound.player.playbackRate = 1 + Math.abs(ball.direction.x) * 0.1;
